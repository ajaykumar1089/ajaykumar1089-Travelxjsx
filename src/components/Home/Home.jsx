...
const Home = () => {
  ...
  const buttons = [
    ...
    { id: 3, label: "Hotels & Home Stays", icon: "fas fa-hotel" },
    { id: 4, label: "Cruise", icon: "fas fa-ship" },
    { id: 5, label: "Tourist Map", icon: "fas fa-map-marked-alt" },
    { id: 6, label: "Hire Trip Coach", title: "Hire Tourist Guide", icon: "fas fa-user-tie guide-icon" },
